(function () {
  ...
  // タイトルを押すと太陽系に移動する
  // var btn = document.getElementById("tech");
  ...
  //   while (rad < 200) {
  //     theta += 0.1;
  //     rad = Math.cos(THREE.Math.degToRad(theta)) * 300;
  //     // camera.position.y = 200; // 追加
  //     camera.position.y = rad; // 追加; // 追加
  //     camera.lookAt(scene.position); // 追加
